...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    $(document).on("click", "[data-save]", function () {
      ...
      var text = $(this).closest("td").find("input, textarea").val();
      value[$(this).attr("data-save")] = text;
      var html = '<span class="editable">' + text + "</span>";
      console.log(html);
      ...
      console.log(html);
      html += '<button class="btn btn-sm btn-outline-primary" data-edit="' + $(this).attr("data-save") + '" data-variant_id="' + $(this).attr("data-variant_id") + '"><i class="fa fa-edit"></i></button>';
      console.log(html);
      $(this).closest("td").html(html);
