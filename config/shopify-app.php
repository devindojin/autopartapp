...
return [
    ...
    */
    ...
    'webhooks' => [
        ...
        */
        ...
        //     'address' => env('APP_URL').'/webhook/inventory_items-create'
        // ],
        // [
        //     'topic' => 'inventory_items/update',
        //     'address' => env('APP_URL').'/webhook/inventory_items-update'
        // ],
        // [
        //     'topic' => 'inventory_items/delete',
        //     'address' => env('APP_URL').'/webhook/inventory_items-delete'
        // ],
        // [
        //     'topic' => 'inventory_levels/connect',
        //     'address' => env('APP_URL').'/webhook/inventory_levels-connect'
        // ],
        // [
        //     'topic' => 'inventory_levels/disconnect',
        //     'address' => env('APP_URL').'/webhook/inventory_levels-disconnect'
        // ],
        // [
        ...
        // [
        //     'topic' => 'ORDERS_EDITED',
        //     'address' => env('APP_URL').'/webhook/orders-edited'
        // ]
    ],
    ...
    */
    ...
    'scripttags' => [
        ...
        */
        [
            'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', config('app.asset_url') . '/js/autopart.js'),
            'event' => env('SHOPIFY_SCRIPTTAG_1_EVENT', 'onload'),
            'display_scope' => env('SHOPIFY_SCRIPTTAG_1_DISPLAY_SCOPE', 'online_store')
        ],
    ],
